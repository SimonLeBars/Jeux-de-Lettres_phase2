...
public class DoubleWordSquare extends SquareImplementation implements ScrabbleSquare, Serializable {
    /**
     ...
     * Color of the square.
     */
    private static final String color = ANSI_Color.PURPLE.toString();
