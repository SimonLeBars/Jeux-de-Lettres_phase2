...
public class TripleLetterSquare extends SquareImplementation implements ScrabbleSquare, Serializable {
    /**
     * Multiplier bonus used for Scrabble. Acts on the value of the contained tile.
     */
    private static final int letterMultiplier = 3;
     ...
     * Color of the square.
     */
    private static final String color = ANSI_Color.BLUE.toString();
